...
unsafe extern "C" fn CharToHex(mut c: libc::c_uchar, mut hexBuf: *mut libc::c_char) {
    let mut hexchar: *const libc::c_char = b"0123456789ABCDEF\0" as *const u8
...
pub unsafe extern "C" fn yajl_string_encode(
    ...
    while end < len {
        ...
        if !escaped.is_null() {
            ...
            print
                .expect(
                    "non-null function pointer",
                )(ctx, escaped, strlen(escaped) as libc::c_uint as size_t);
    ...
    print
        .expect(
            "non-null function pointer",
        )(ctx, str.offset(beg as isize) as *const libc::c_char, end.wrapping_sub(beg));
}
unsafe extern "C" fn hexToDigit(
    mut val: *mut libc::c_uint,
    mut hex: *const libc::c_uchar,
) {
    ...
    while i < 4 as libc::c_int as libc::c_uint {
        ...
        if c as libc::c_int >= 'A' as i32 {
            c = ((c as libc::c_int & !(0x20 as libc::c_int)) - 7 as libc::c_int)
                as libc::c_uchar;
        }
...
unsafe extern "C" fn Utf32toUtf8(
    mut codepoint: libc::c_uint,
    mut utf8Buf: *mut libc::c_char,
) {
    if codepoint < 0x80 as libc::c_int as libc::c_uint {
        ...
        *utf8Buf
            .offset(
                0 as libc::c_int as isize,
            ) = (codepoint >> 6 as libc::c_int | 0xc0 as libc::c_int as libc::c_uint)
            as libc::c_char;
        *utf8Buf
            .offset(
                1 as libc::c_int as isize,
            ) = (codepoint & 0x3f as libc::c_int as libc::c_uint
        ...
        *utf8Buf
            .offset(
                0 as libc::c_int as isize,
            ) = (codepoint >> 12 as libc::c_int | 0xe0 as libc::c_int as libc::c_uint)
            as libc::c_char;
        *utf8Buf
            .offset(
                1 as libc::c_int as isize,
        ...
        *utf8Buf
            .offset(
                0 as libc::c_int as isize,
            ) = (codepoint >> 18 as libc::c_int | 0xf0 as libc::c_int as libc::c_uint)
            as libc::c_char;
        *utf8Buf
            .offset(
                1 as libc::c_int as isize,
...
pub unsafe extern "C" fn yajl_string_decode(
    ...
    while end < len {
        if *str.offset(end as isize) as libc::c_int == '\\' as i32 {
            ...
            let mut unescaped: *const libc::c_char = b"?\0" as *const u8
                as *const libc::c_char;
            yajl_buf_append(
                buf,
